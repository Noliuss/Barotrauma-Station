...
using static Content.Shared.Skill.ChemistryModifiers.StrengthModifierMetabolismComponent;
...
public sealed partial class MetabolismStrengthModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<StrengthModifierMetabolismComponent, RefreshSkillModifiersEvent>(OnRefreshMovespeed);
    }
    ...
    private void OnRefreshMovespeed(EntityUid uid, StrengthModifierMetabolismComponent component, RefreshSkillModifiersEvent args)
    {
