...
using static Content.Shared.Skill.ChemistryModifiers.LuckModifierMetabolismComponent;
...
public sealed partial class MetabolismLuckModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<LuckModifierMetabolismComponent, RefreshSkillModifiersEvent>(OnRefreshMovespeed);
    }
    ...
    private void OnRefreshMovespeed(EntityUid uid, LuckModifierMetabolismComponent component, RefreshSkillModifiersEvent args)
    {
