...
using static Content.Shared.Skill.ChemistryModifiers.EnduranceModifierMetabolismComponent;
using Content.Shared.Skill.ChemistryModifiers;

namespace Content.Shared.Skill.ChemistryModifiers;
public sealed partial class MetabolismEnduranceModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<EnduranceModifierMetabolismComponent, RefreshSkillModifiersEvent>(OnRefreshMovespeed);
    }
    ...
    private void OnRefreshMovespeed(EntityUid uid, EnduranceModifierMetabolismComponent component, RefreshSkillModifiersEvent args)
    {
