...
using static Content.Shared.Skill.ChemistryModifiers.CharismaModifierMetabolismComponent;
...
public sealed partial class MetabolismCharismaModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CharismaModifierMetabolismComponent, RefreshSkillModifiersEvent>(OnRefreshMovespeed);
    }
    ...
    private void OnRefreshMovespeed(EntityUid uid, CharismaModifierMetabolismComponent component, RefreshSkillModifiersEvent args)
    {
