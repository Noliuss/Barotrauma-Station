...
using static Content.Shared.Skill.ChemistryModifiers.AgilityModifierMetabolismComponent;
...
public sealed partial class MetabolismAgilityModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<AgilityModifierMetabolismComponent, RefreshSkillModifiersEvent>(OnRefreshMovespeed);
    }
    ...
    private void OnRefreshMovespeed(EntityUid uid, AgilityModifierMetabolismComponent component, RefreshSkillModifiersEvent args)
    {
