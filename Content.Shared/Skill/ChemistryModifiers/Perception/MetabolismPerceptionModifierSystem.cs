...
using static Content.Shared.Skill.ChemistryModifiers.PerceptionModifierMetabolismComponent;
...
public sealed partial class MetabolismPerceptionModifierSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<PerceptionModifierMetabolismComponent, RefreshSkillModifiersEvent>(OnRefreshMovespeed);
    }
    ...
    private void OnRefreshMovespeed(EntityUid uid, PerceptionModifierMetabolismComponent component, RefreshSkillModifiersEvent args)
    {
