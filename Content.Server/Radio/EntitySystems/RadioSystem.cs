...
public sealed class RadioSystem : EntitySystem
{
    ...
    private void OnIntrinsicSpeak(EntityUid uid, IntrinsicRadioTransmitterComponent component, EntitySpokeEvent args)
    {
        ...
        {
            SendRadioMessage(uid, args.Message, args.Channel.ID, uid, args.Language);
    ...
    public void SendRadioMessage(EntityUid messageSource, string message, RadioChannelPrototype channel, EntityUid radioSource, int? frequency = null, LanguagePrototype? language = null, bool escapeMarkup = true)
    {
        if (language == null)
